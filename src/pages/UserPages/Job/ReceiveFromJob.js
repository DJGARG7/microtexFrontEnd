...
function ReceiveFromJob({ userDetails }) {
  ...
  return (
    <div className={styles["main"]}>
      ...
      <button type="button" onClick={()=>setinvoicemodal(true)}>View e bill</button>
      <Modal open={invoicemdoal} onClose={() => setinvoicemodal(false)}>
        <div >
          <PDFViewer width={"595px"} height={"500px"}>
            <PdfFormat />
          </PDFViewer>
          <PDFDownloadLink document={<PdfFormat />} fileName="somename.pdf">
